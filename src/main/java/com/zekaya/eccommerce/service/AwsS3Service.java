package com.zekaya.eccommerce.service;
...
public class AwsS3Service {
    ...
    private final String bucketName = "zekaya-ecom";
    ...
    public String saveImageToS3(MultipartFile photo){
        try {
           ...
           //create aws credentials using the access and service key
            ...
            e.printStackTrace();
            throw new RuntimeException("Unable to upload image to s3bucket: " +e.getMessage());
        }
    }
}
